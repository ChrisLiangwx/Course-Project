...
class CarWorld extends JPanel {
    ...
    public CarWorld() {
        ...
        redCar = toolkit.getImage("BridgeModule/src/image/redcar.gif");
        mt.addImage(redCar, 0);
        blueCar = toolkit.getImage("BridgeModule/src/image/bluecar.gif");
        mt.addImage(blueCar, 1);
        bridge = toolkit.getImage("BridgeModule/src/image/bridge1.gif");
